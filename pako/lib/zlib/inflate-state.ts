...
class InflateState {
  ...
  // TODO: may be {}
  head: GZipHead | null = null;           /* where to save gzip header information */
  ...
  lencode: Int32Array | null = null;          /* starting table for length/literal codes */
  ...
  */
  ...
  lendyn: Int32Array | null = null;              /* dynamic table for length/literal codes (JS specific) */
  distdyn: Int32Array | null = null;             /* dynamic table for distance codes (JS specific) */
